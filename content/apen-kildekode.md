...
---
# Introduksjon til Åpen kildekode
...
1. Friheten til å kjøre programmet som du ønsker, uansett hensikt (frihet 0).
2. Friheten til å studere hvordan programmet virker, og tilpasse det til dine behov (frihet 1).
3. Friheten til å distribuere kopier slik du kan hjelpe din neste (frihet 2).
4. Friheten til å forbedre programmet, og gi det ut med dine forbedringer til offentlig eie, slik at hele samfunnet kan få utbytte (frihet 3).
...
## Det er ikke åpen kildekode uten den riktige lisensen
...
Enkelte avsnitt i denne artikkelen er hentet fra og bearbeidet fra [«åpen kildekode» i Store norske leksikon](https://snl.no/%C3%A5pen_kildekode), skrevet av Thomas Gramstad ved Universitetet i Oslo.

Store norske leksikon-artikkelen er merket for fri gjenbruk og er lisensiert under [Creative Commons Navngivelse-DelPåSammeVilkår 3.0 (CC BY-SA 3.0)](https://creativecommons.org/licenses/by-sa/3.0/deed.no).
